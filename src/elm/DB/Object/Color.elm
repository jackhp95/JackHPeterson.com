...
module DB.Object.Color exposing (createdAt, id, updatedAt)
...
id : SelectionSet DB.ScalarDecoders.Id DB.Object.Color
id =
    Object.selectionForField "ScalarDecoders.Id" "id" [] (DB.ScalarDecoders.decoders |> DB.Scalar.unwrapDecoders |> .decoderId)


createdAt : SelectionSet DB.ScalarDecoders.DateTime DB.Object.Color
createdAt =
...
updatedAt : SelectionSet DB.ScalarDecoders.DateTime DB.Object.Color
updatedAt =
